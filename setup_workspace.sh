...
echo "source /home/$USER/src/distal_ros2/install/setup.bash --extend" >> /home/$USER/.bashrc
echo "source /home/$USER/src/ws_livox/install/setup.bash --extend" >> /home/$USER/.bashrc
